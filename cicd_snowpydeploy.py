...
def snowpydeploy(root_folder, snowflake_account, snowflake_user, snowflake_passwrod, snowflake_role, snowflake_warehouse, snowflake_database, change_history_table_override, vars, create_change_history_table, autocommit, verbose, dry_run, environment, git_repository, git_branch, git_commit, release_comments):
  if dry_run:
...
def main():
  ...
  snowpydeploy(args.root_folder, args.snowflake_account, args.snowflake_user, args.snowflake_password, args.snowflake_role, args.snowflake_warehouse, args.snowflake_database, args.change_history_table, args.vars, args.create_change_history_table, args.autocommit, args.verbose, args.dry_run,args.environment,args.git_repository,args.git_branch,args.git_commit,args.release_comments)
